...
export function LeadForm() {
  ...
  if (status === 'success') {
    return (
      <section id="lead" className="bg-bg py-20 sm:py-28">
        <div className="container-content">
          <div className="mx-auto max-w-xl rounded-token-lg bg-surface p-8 text-center shadow-token-lg ring-1 ring-brand/5 sm:p-12">
            <span className="mx-auto inline-flex h-16 w-16 items-center justify-center rounded-full bg-success/15 text-success">
              <Icon name="check" className="h-8 w-8" />
            </span>
            <h2 className="mt-6 text-3xl font-extrabold text-brand">Спасибо! Перезвоним</h2>
    ...
    <section id="lead" className="bg-bg py-20 sm:py-28">
      <div className="container-content grid gap-10 lg:grid-cols-2 lg:items-center">
        ...
        <form
          onSubmit={onSubmit}
          noValidate
          className="rounded-token-lg bg-surface p-6 shadow-token-lg ring-1 ring-brand/5 sm:p-8"
        >
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                className={clsx(
                  'w-full rounded-token border bg-surface px-4 py-3 text-base text-text outline-none transition-colors duration-200 focus:border-accent',
                  errors.name ? 'border-error' : 'border-brand/15',
                )}
            ...
            <div>
              ...
              <input
                ...
                className={clsx(
                  'w-full rounded-token border bg-surface px-4 py-3 text-base text-text outline-none transition-colors duration-200 focus:border-accent',
                  errors.phone ? 'border-error' : 'border-brand/15',
                )}
            ...
            <div>
              ...
              <select
                ...
                name="service"
                defaultValue=""
                className="w-full rounded-token border border-brand/15 bg-surface px-4 py-3 text-base text-text outline-none transition-colors duration-200 focus:border-accent"
              >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                maxLength={1000}
                className="w-full resize-y rounded-token border border-brand/15 bg-surface px-4 py-3 text-base text-text outline-none transition-colors duration-200 focus:border-accent"
            ...
            <div>
              <label htmlFor="consent" className="flex items-start gap-3 text-sm text-text-muted">
                <input
                  ...
                  className="mt-0.5 h-5 w-5 shrink-0 rounded border-brand/30 text-accent focus-visible:ring-accent"
                />
                <span>
                  Согласен на обработку{' '}
                  <a href="#privacy" className="font-medium text-brand underline">
                    персональных данных
                  </a>
                </span>
              </label>
