...
export function Steps() {
  ...
  return (
    <section id="steps" className="bg-bg py-20 sm:py-28">
      <div className="container-content" ref={sectionRef}>
        ...
        <div className="relative mt-14">
          ...
          <span
            aria-hidden
            className="absolute left-5 top-0 h-full w-0.5 bg-brand/10 md:left-0 md:top-6 md:h-0.5 md:w-full"
          />
          ...
          <ol className="relative grid grid-cols-1 gap-8 md:grid-cols-5 md:gap-4">
            {steps.map((step) => (
              <li key={step.n} data-step className="relative pl-14 md:pl-0 md:pt-16">
                <span className="absolute left-0 top-0 flex h-11 w-11 items-center justify-center rounded-full bg-brand font-heading text-base font-bold text-accent ring-4 ring-bg md:left-0">
                  {step.n}
                </span>
