...
// Footer (спека §3.9): контакты, мессенджеры, зона работ, повтор CTA,
// ссылка на политику обработки ПД (нужна из-за consent в форме).
export function Footer() {
  const year = new Date().getFullYear();

  return (
    <footer className="border-t border-white/10 text-text-muted">
      <div className="container-content grid gap-10 py-16 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            <li>
              <a href={`tel:${contacts.phone}`} className="inline-flex items-center gap-2 transition-colors duration-200 hover:text-white">
            ...
            {contacts.whatsapp && (
              <li>
                <a href={contacts.whatsapp} className="inline-flex items-center gap-2 transition-colors duration-200 hover:text-white" target="_blank" rel="noopener noreferrer">
            ...
            {contacts.telegram && (
              <li>
                <a href={contacts.telegram} className="inline-flex items-center gap-2 transition-colors duration-200 hover:text-white" target="_blank" rel="noopener noreferrer">
      ...
      <div className="border-t border-white/10">
        <div className="container-content flex flex-col gap-2 py-6 text-sm sm:flex-row sm:items-center sm:justify-between">
          ...
          <a id="privacy" href="#privacy" className="underline transition-colors duration-200 hover:text-white">
